...
SCIL is a library for the programming language C supporting lossy as well as
lossless compression. Users are able to provide parameters to restrict the
performance of the compression, restricting throughput and/or error tolerance to
a minimum. Given the current user specified context, SCIL will then be able to
automatically choose the best compression algorithm out of an array of
procedures.
