...
typedef struct scil_compression_algorithm {
  union{
    ...
    struct{
      ...
      int (*compress_float)(const scil_context_t* ctx, int64_t* restrict compressed_buf_in_out, size_t* restrict out_size, float*restrict data_in, const scil_dims* dims);
      int (*decompress_float)(float*restrict data_out, scil_dims* dims, int64_t*restrict compressed_buf_in, const size_t in_size);

      int (*compress_double)(const scil_context_t* ctx, int64_t* restrict compressed_buf_in_out, size_t* restrict out_size, double*restrict data_in, const scil_dims* dims);
      int (*decompress_double)( double*restrict data_out, scil_dims* dims, int64_t*restrict compressed_buf_in, const size_t in_size);

      int (*compress_int8)(const scil_context_t* ctx, int64_t* restrict compressed_buf_in_out, size_t* restrict out_size, int8*restrict data_in, const scil_dims* dims);
      int (*decompress_int8)( int8*restrict data_out, scil_dims* dims, int64_t*restrict compressed_buf_in, const size_t in_size);

      int (*compress_int16)(const scil_context_t* ctx, int64_t* restrict compressed_buf_in_out, size_t* restrict out_size, int16*restrict data_in, const scil_dims* dims);
      int (*decompress_int16)( int16*restrict data_out, scil_dims* dims, int64_t*restrict compressed_buf_in, const size_t in_size);

      int (*compress_int32)(const scil_context_t* ctx, int64_t* restrict compressed_buf_in_out, size_t* restrict out_size, int32*restrict data_in, const scil_dims* dims);
      int (*decompress_int32)( int32*restrict data_out, scil_dims* dims, int64_t*restrict compressed_buf_in, const size_t in_size);

      int (*compress_int64)(const scil_context_t* ctx, int64_t* restrict compressed_buf_in_out, size_t* restrict out_size, int64*restrict data_in, const scil_dims* dims);
    ...
    struct{
      int (*compress_float)(const scil_context_t* ctx, byte* restrict compressed_buf_in_out, size_t* restrict out_size, float*restrict data_in, const scil_dims* dims);
      int (*decompress_float)(float*restrict data_out, scil_dims* dims, byte*restrict compressed_buf_in, const size_t in_size);

      int (*compress_double)(const scil_context_t* ctx, byte* restrict compressed_buf_in_out, size_t* restrict out_size, double*restrict data_in, const scil_dims* dims);
      int (*decompress_double)( double*restrict data_out, scil_dims* dims, byte*restrict compressed_buf_in, const size_t in_size);

      int (*compress_int8)(const scil_context_t* ctx, byte* restrict compressed_buf_in_out, size_t* restrict out_size, int8*restrict data_in, const scil_dims* dims);
      int (*decompress_int8)( int8*restrict data_out, scil_dims* dims, byte*restrict compressed_buf_in, const size_t in_size);

      int (*compress_int16)(const scil_context_t* ctx, byte* restrict compressed_buf_in_out, size_t* restrict out_size, int16*restrict data_in, const scil_dims* dims);
      int (*decompress_int16)( int16*restrict data_out, scil_dims* dims, byte*restrict compressed_buf_in, const size_t in_size);

      int (*compress_int32)(const scil_context_t* ctx, byte* restrict compressed_buf_in_out, size_t* restrict out_size, int32*restrict data_in, const scil_dims* dims);
      int (*decompress_int32)( int32*restrict data_out, scil_dims* dims, byte*restrict compressed_buf_in, const size_t in_size);

      int (*compress_int64)(const scil_context_t* ctx, byte* restrict compressed_buf_in_out, size_t* restrict out_size, int64*restrict data_in, const scil_dims* dims);
